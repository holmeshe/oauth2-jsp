...
//			System.out.println("pass:" + uRI.getAuthority());
...
//				System.out.println("param:"+key+":"+Utility.toQueryString(val));
				if (Utility.checkStringIsNotVoid((mapURI.get(key)))) {
					mapURI.put(key, mapURI.get(key) + "&" + Utility.toQueryString(val));
				} else {
			...
			String res = (Utility.checkStringIsNotVoid((mapURI.get("scheme"))) ? mapURI.get("scheme")
					+ "://" : "")
					+ (Utility.checkStringIsNotVoid((mapURI.get("user"))) ? mapURI.get("user")
							+ (Utility.checkStringIsNotVoid(mapURI.get("pass")) ? ":"
									+ mapURI.get("pass") : "") + "@" : "")
					+ (Utility.checkStringIsNotVoid(mapURI.get("host")) ? mapURI.get("host") : "")
					+ (Utility.checkStringIsNotVoid(mapURI.get("port")) ? ":" + mapURI.get("port")
							: "")
					+ (Utility.checkStringIsNotVoid(mapURI.get("path")) ? mapURI.get("path") : "")
